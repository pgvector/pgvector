...
HalfvecL2SquaredDistanceAvx512(int dim, half * ax, half * bx)
{
	...
	__m512h		dist_512h_temp = _mm512_setzero_ph();
	...
	__m512		bxi_512;
	__m512		diff_512;
	__m512		dist_512 = _mm512_setzero_ps();
...
HalfvecCosineSimilarityAvx512(int dim, half * ax, half * bx)
{
	...
	__m512h		sim_512h_temp = _mm512_setzero_ph();
	__m512h		na_512h_temp = _mm512_setzero_ph();
	__m512h		nb_512h_temp = _mm512_setzero_ph();
	...
	__m512		axi_512;
	__m512		bxi_512;
	__m512		sim_512= _mm512_setzero_ps();
	__m512		na_512 = _mm512_setzero_ps();
	__m512		nb_512 = _mm512_setzero_ps();
