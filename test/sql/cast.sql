...
SELECT '{NaN}'::real[]::halfvec;
SELECT '{Infinity}'::real[]::halfvec;
SELECT '{-Infinity}'::real[]::halfvec;
SELECT '{}'::real[]::halfvec;
...
SELECT '{1,2,3}'::double precision[]::halfvec;
SELECT '{1,2,3}'::double precision[]::halfvec(3);
SELECT '{1,2,3}'::double precision[]::halfvec(2);
