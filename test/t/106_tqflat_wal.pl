...
# Test generic xlog record work for tqflat index replication.
use strict;
...
# Create tqflat index on primary
...
$node_primary->safe_psql("postgres", "CREATE INDEX ON tst USING tqflat (v vector_l2_ops);");
